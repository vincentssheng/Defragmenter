...
defragmenter.o : defragmenter.cpp defragmenter.h QuadraticProbing.h mynew.h BinaryHeap.h
	g++ -ansi -Wall -g -c defragmenter.cpp

DefragRunner.o : DefragRunner.cpp DefragRunner.h mynew.h CPUTimer.h defragmenter.h QuadraticProbing.h BinaryHeap.h
